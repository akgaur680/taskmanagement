    ...
    <div class='project-tasks'>
      <div class='project-column'>
        <div class='project-column-heading'>
          <h2 class='project-column-heading__title'>Today's Tasks</h2><button class='project-column-heading__options'><i class="fas fa-ellipsis-h"></i></button>
        </div>
        @foreach (@$recurringsubtasks as $subtasks )
        
        <div class='task' draggable='true'>
          <div class='task__tags'> <span>Title</span> <span class='task__tag task__tag--copyright'>{{@$subtasks['title']}}</span><button class='task__options'><i class="fas fa-ellipsis-h"></i></button></div>
          <p><span class="fw-bold" >Description : </span>{{@$subtasks['description']}}</p>
